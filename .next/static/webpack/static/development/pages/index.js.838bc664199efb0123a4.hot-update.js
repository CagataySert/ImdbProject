...
function (_React$Component) {
  ...
  function Page() {
    ...
    _this.handleAddFavorite = function (event, filmId) {
      Object(_serverApi_LocalStorage__WEBPACK_IMPORTED_MODULE_8__["default"])(filmId).then(function () {
...
var LocalStorageApi = function LocalStorageApi() {
  ...
  this.addFilmToFavorite = function (filmId) {
    return new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_1___default.a(function (resolve, reject) {
      var response = localStorage.getItem(_constants_constants__WEBPACK_IMPORTED_MODULE_4__["KEY"]);

      if (!!response) {
        var filmArray = JSON.parse(response);
        filmArray.push(filmId);
        localStorage.setItem(_constants_constants__WEBPACK_IMPORTED_MODULE_4__["KEY"], _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(filmArray));
        resolve();
      }

      localStorage.setItem(_constants_constants__WEBPACK_IMPORTED_MODULE_4__["KEY"], _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()([filmId]));
      resolve();
    });
  };
};

/* harmony default export */ __webpack_exports__["default"] = (LocalStorageApi);

/***/ })

})
//# sourceMappingURL=index.js.838bc664199efb0123a4.hot-update.js.map